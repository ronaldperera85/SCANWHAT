...
<aside class="sidebar expanded">
    <header>
        ...
        <nav>
           <ul>
               <li><a href="#" data-page="pages/dashboard.php"><i class="fas fa-home"></i><span>Dashboard</span></a></li>
        ...
        <div class="bottom-section">
            <div class="logout">
                <span id="logout-link">
        <i class="fas fa-sign-out-alt" id="logout-icon"></i><a href="pages/logout.php">Logout</a>
    </span>
</div>
